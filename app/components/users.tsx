    ...
    <div className="p-4 pb-8 pr-6 pl-6 relative width-adjust rounded-lg lg:w-[200%] md:w-[200%] -left-10 max-w-sm mx-auto">
      ...
      <div className="relative mb-4">
        <input
          ...
          className="w-full px-3 py-2 border bg-gray-100 border-gray-300 rounded-2xl border-none outline-none focus:ring-2 focus:ring-gray-200"
        />
        <Search size={18} className="absolute right-3 top-3 text-gray-700" />
      </div>
